<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="BlogWeb1.WebForm1" %>
                ...
                <ItemTemplate>
                    <div class="my-auto">
                        ...
                        <div class="subheading mb-5">
                            ...
                            <a href="mailto:name@email.com">MAİL:  
                                <asp:Label ID="Label5" runat="server" Text='<%#Eval("MAİL") %>'></asp:Label>
                            </a>
                            <hr />
                        </div>
                        <p class="lead mb-5">
                    ...
                    <div class="my-auto">
                        ...
                        <div class="resume-item d-flex flex-column flex-md-row mb-5">
                            <div class="resume-content mr-auto">
                                <h3 class="mb-0">
                                    <asp:Label ID="Label7" runat="server" Text='<%#Eval("BAŞLIK") %>'></asp:Label>
                                </h3>
                                <div class="subheading mb-3">
                                    <asp:Label ID="Label8" runat="server" Text='<%#Eval("ALTBAŞLIK") %>'></asp:Label>

                                </div>
                                <p>
                                    <asp:Label ID="Label9" runat="server" Text='<%#Eval("AÇIKLAMA") %>'></asp:Label>
                                </p>
                            </div>
                            <div class="resume-date text-md-right">
                                <span class="text-primary">
                                    <asp:Label ID="Label10" runat="server" Text='<%#Eval("TARİH") %>'></asp:Label>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="my-auto">
                        ...
                        <div class="resume-item d-flex flex-column flex-md-row mb-5">
                            <div class="resume-content mr-auto">
                                ...
                                <div class="subheading mb-3">
                                    <asp:Label ID="Label12" runat="server" Text='<%#Eval("ALTBAŞ") %>'></asp:Label>
                                </div>
                                <div>
                                    <asp:Label ID="Label13" runat="server" Text='<%#Eval("AÇIKLAMA") %>'></asp:Label>
                            ...
                            <div class="resume-date text-md-right">
                                <span class="text-primary">
                                    <asp:Label ID="Label15" runat="server" Text='<%#Eval("TARİH") %>'></asp:Label>
                    ...
                    <ItemTemplate>
                        <ul class="fa-ul mb-0">
                            <li>
                                ...
                                <asp:Label ID="Label17" runat="server" Text='<%#Eval("ÖDÜL") %>'></asp:Label></li>
                        </ul>
                    </ItemTemplate>
                </asp:Repeater>
            </div>
