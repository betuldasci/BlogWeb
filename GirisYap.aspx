<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GirisYap.aspx.cs" Inherits="BlogWeb1.GirisYap" %>
...
<%--                            <input type="submit" value="Login" class="btn float-right login_btn">--%>
                            ...
                            <asp:Button ID="Button1" runat="server" Text="Giriş Yap" CssClass="btn float-right login-btn" OnClick="Button1_Click" />
                        </div>
                    </form>
                </div>
