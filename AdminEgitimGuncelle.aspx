<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminEgitimGuncelle.aspx.cs" Inherits="BlogWeb1.AdminEgitimGuncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <form id="Form1" runat="server">
      <div class="form-group">
          ...
          <div>
              <asp:Label ID="Label6" runat="server" Text="GENEL NOT ORTALAMASI"></asp:Label>
